...
(() => {
  ...
  var fromMaybeM = function(dictApplicative) {
    ...
    return function(v) {
      return function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at Utility (line 105, column 1 - line 105, column 56): " + [v.constructor.name, v1.constructor.name]);
      };
    };
  };
  ...
  var showComponent = {
    show: function(v) {
      var ty = function() {
        ...
        ;
        throw new Error("Failed pattern match at Ui.Component (line 53, column 10 - line 55, column 23): " + [v.kids.constructor.name]);
      }();
      var label4 = function() {
        ...
        ;
        throw new Error("Failed pattern match at Ui.Component (line 50, column 13 - line 52, column 29): " + [v.name.constructor.name]);
      }();
      return "<" + (label4 + (" / " + (ty + ">")));
    }
  };
          ...
          return function(content3) {
            ...
            return function __do() {
              ...
              var kids$prime = function() {
                ...
                ;
                throw new Error("Failed pattern match at Ui.Component (line 125, column 12 - line 134, column 31): " + [content3.constructor.name]);
              }();
              return {
                name: opts.name,
                element: e,
  ...
  var root = function(kids) {
    return function __do() {
      ...
      var v = new1(toDocument(doc))({
        name: pure1("root"),
        classes: ["root"]
      })(pure22(map1(pure2)(kids)))();
      var body2 = bind2(body(doc))(fromMaybeM2(throwError2(error("no body"))))();
      return appendChild(toNode(v.element))(toNode2(body2))();
    };
  };
  var getKidsRef = function(v) {
    if (v.kids instanceof Nothing) {
      return throwError2(error("getKidsRef " + show1(v)));
    }
    ;
    if (v.kids instanceof Just) {
    ...
    ;
    throw new Error("Failed pattern match at Ui.Component (line 144, column 28 - line 146, column 25): " + [v.kids.constructor.name]);
  };
  var removeKid = function(i) {
    return function(v) {
      return function __do() {
        ...
        var v1 = fromMaybeM2(throwError2(error("removeKid " + (show2(i) + (" " + show1(v))))))(index(kids)(i))();
        ...
        var kids$prime = fromMaybeM2(throwError2(error("replaceKid " + (show2(i) + (" " + show1(v))))))(deleteAt(i)(kids))();
  ...
  var removeDescendants = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Ui.Component (line 225, column 35 - line 229, column 32): " + [v.kids.constructor.name]);
  };
    ...
    return function(v) {
      return function(v1) {
        return function __do() {
          ...
          var kids = read(kidsRef)();
          var $80 = i < (length(kids) - 1 | 0);
          if ($80) {
            var v2 = fromMaybeM2(throwError2(error("addKid " + (show2(i) + (" " + show1(v1))))))(index(kids)(i + 1 | 0))();
            insertBefore(toNode(v.element))(toNode(v2.element))(toNode(v1.element))();
            var kids$prime = fromMaybeM2(throwError2(error("addKid " + (show2(i) + (" " + show1(v1))))))(insertAt(i)(v)(kids))();
            return write(kids$prime)(kidsRef)();
          }
          ;
  ...
  var main = /* @__PURE__ */ discard(discardUnit)(bindAff)(/* @__PURE__ */ log2(monadEffectAff)("main"))(function() {
    return liftEffect2(function __do() {
      var win = windowImpl();
      var doc = map6(toDocument)(document(win))();
      var console2 = $$new3(doc)({
        name: pure3("console"),
      ...
      })(new Left("add a log to the console")), $$new3(doc)({
        name: pure3("button_addLog"),
        tag: "button",
        eventListeners: [{
          eventType: "click",
          eventListener: eventListener(function(_event) {
            return function __do2() {
              var n = composeKleisli3(getKidsRef)(composeKleisli3(read)(function($20) {
                return pure12(length($20));
              }))(console2)();
              var i = div2(n)(2);
  ...
  // output/Ui/index.js
  var main2 = /* @__PURE__ */ launchAff_(main);
