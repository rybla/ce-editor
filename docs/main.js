...
(() => {
  ...
  var showZipperFocus = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Expr (line 407, column 1 - line 411, column 37): " + [v.constructor.name]);
    }
  };
  ...
  var showSpanFocus = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Expr (line 392, column 1 - line 394, column 29): " + [v.constructor.name]);
    }
  };
  ...
  var showHandle = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Expr (line 377, column 1 - line 380, column 64): " + [v.constructor.name]);
    }
  };
  var showExpr = {
    show: function(v) {
  ...
  var genericFragment_ = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Expr (line 520, column 1 - line 520, column 35): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  var offset_inner_Tooth = function(v) {
    return length(v.kids_L);
  };
  var offset_inner_Zipper = function(v) {
    var v1 = unsnoc(v.ts);
    if (v1 instanceof Just) {
      return offset_inner_Tooth(v1.value0.last);
    }
    ;
    if (v1 instanceof Nothing) {
      return length(v.kids_L);
    ...
    ;
    throw new Error("Failed pattern match at Data.Expr (line 266, column 34 - line 268, column 45): " + [v1.constructor.name]);
  };
  ...
  var getDragOrigin = function(v) {
    return function(v1) {
      var v2 = function(v3) {
          ...
          var v6 = function(v7) {
            var v8 = function(v9) {
              var v10 = function(v11) {
                ...
                if (v instanceof ZipperH_Handle) {
                  var $532 = getPoints_ZipperH(v.value0);
                  var $533 = eq5(v1)($532["_OR"]);
                  if ($533) {
        ...
        if (v instanceof SpanH_Handle) {
          var $556 = getPoints_SpanH(v.value0);
          var $557 = eq5(v1)($556["_R"]);
          if ($557) {
  ...
  var atZipper = function(v) {
    return function(e) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Expr (line 344, column 3 - line 363, column 90): " + [v1.constructor.name]);
    };
  };
      ...
      return function(v2) {
        if (v instanceof Point_Handle) {
          ...
          var v3 = function(v4) {
            var v5 = function(v6) {
              var v7 = function(v8) {
                var v9 = function(v10) {
                  ...
                  ;
                  throw new Error("Failed pattern match at Data.Expr (line 424, column 1 - line 424, column 48): " + [unit.constructor.name]);
                };
                var $622 = isAncestorSibling_Point(v.value0)(v1);
                if ($622 instanceof Just) {
                  var $623 = orderedStepAndIndex($622.value0.value0)(v.value0.j);
                  if ($623) {
                    var path_I4 = cons_Path($622.value0.value0)($622.value0.value1);
                    return pure12(new ZipperH_Handle({
                      path_O: v.value0.path,
                      j_OL: function(v10) {
                        return v10["_L"];
                      }(getIndexesAroundStep($622.value0.value0)),
                      j_OR: v.value0.j,
                      path_I: path_I4,
                      j_IL: function(v10) {
                        return v10["_L"];
              ...
              if ($630 instanceof Just) {
                var $631 = orderedIndexAndStep(v.value0.j)($630.value0.value0);
                if ($631) {
                  var path_I3 = cons_Path($630.value0.value0)($630.value0.value1);
                  return pure12(new ZipperH_Handle({
                    path_O: v.value0.path,
                    j_OL: v.value0.j,
                    j_OR: function(v8) {
            ...
            var $638 = isAncestorSibling_Point(v1)(v.value0);
            if ($638 instanceof Just) {
              var $639 = orderedStepAndIndex($638.value0.value0)(v1.j);
              if ($639) {
                var path_I2 = cons_Path($638.value0.value0)($638.value0.value1);
                return pure12(new ZipperH_Handle({
                  path_O: v1.path,
                  j_OL: function(v6) {
                    return v6["_L"];
          ...
          if ($646 instanceof Just) {
            var $647 = orderedIndexAndStep(v.value0.j)($646.value0.value0);
            if ($647) {
              var path_I = cons_Path($646.value0.value0)($646.value0.value1);
              return pure12(new ZipperH_Handle({
                path_O: v1.path,
                j_OL: v1.j,
                j_OR: function(v4) {
        ...
        if (v instanceof SpanH_Handle) {
          ...
          ;
          throw new Error("Failed pattern match at Data.Expr (line 492, column 45 - line 505, column 27): " + [v.value1.constructor.name]);
        }
        ;
        if (v instanceof ZipperH_Handle) {
          ...
          ;
          throw new Error("Failed pattern match at Data.Expr (line 509, column 40 - line 510, column 27): " + [v.value1.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Data.Expr (line 424, column 1 - line 424, column 48): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
      };
    };
  };
  ...
  var evalQ = function(render) {
    return function(ref3) {
      return function(q2) {
        return bind13(liftEffect4(read(ref3)))(function(v) {
          return evalM(render)(ref3)(v["component"]["eval"](new Query(map18(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
  ...
  var disabledMessageLabels = ["Editor . ViewExpr"];
  ...
  var map110 = /* @__PURE__ */ map(/* @__PURE__ */ functorExceptT(functorHalogenM));
  ...
  var genericViewPointStyle_ = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Ui.Editor (line 626, column 1 - line 626, column 41): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  var show52 = /* @__PURE__ */ show(showViewPointStyle);
  ...
  var toggleViewPointStyle = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Ui.Editor (line 422, column 1 - line 422, column 68): " + [v.constructor.name]);
  };
  var toggleHandleViewPointStyles = function(v) {
    return function(v1) {
      ...
      ;
      throw new Error("Failed pattern match at Ui.Editor (line 395, column 1 - line 395, column 77): " + [v.constructor.name, v1.constructor.name]);
    };
  };
    ...
    return bind7(gets2(function(v) {
      ...
      return bind7(gets2(function(v) {
        ...
        if (v instanceof Just) {
          ...
          ;
          throw new Error("Failed pattern match at Ui.Editor (line 364, column 32 - line 385, column 21): " + [v1.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Ui.Editor (line 362, column 33 - line 385, column 21): " + [v.constructor.name]);
      });
    });
  };
  ...
  var handleViewPointAction = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Ui.Editor (line 703, column 1 - line 703, column 61): " + [v.constructor.name]);
  };
  var point_component = /* @__PURE__ */ function() {
    var render = function(state3) {
      return div2([classes2(fold4([["Point"], [show52(state3.style)]])), onMouseDown(function($552) {
        return ViewPointInteraction_ViewPointAction.create(StartDrag_ViewPointInteraction.create($552));
      }), onMouseEnter(function($553) {
        return ViewPointInteraction_ViewPointAction.create(MidDrag_ViewPointInteraction.create($553));
      })])([text6(" ")]);
    };
    var $$eval = mkEval({
      finalize: defaultEval.finalize,
      initialize: pure18(Initialize_ViewPointAction.value),
      receive: function($554) {
        return pure18(Receive_ViewPointAction.create($554));
      },
      handleQuery: function(query32) {
        return bind16(get1)(function(state3) {
          return bind16(runExceptT(handleViewPointQuery(query32)))(function(v1) {
            if (v1 instanceof Left) {
              return discard24(put1(state3))(function() {
                return discard24(function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at Ui.Editor (line 666, column 13 - line 668, column 71): " + [v1.value0.constructor.name]);
                }())(function() {
                  return pure24(none3);
                });
              });
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 663, column 53 - line 670, column 35): " + [v1.constructor.name]);
          });
        });
      },
          ...
          return bind16(runExceptT(handleViewPointAction(action2)))(function(v1) {
            if (v1 instanceof Left) {
              return discard24(put1(state3))(function() {
                ...
                ;
                throw new Error("Failed pattern match at Ui.Editor (line 676, column 13 - line 678, column 71): " + [v1.value0.constructor.name]);
              });
            }
            ;
            if (v1 instanceof Right) {
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 673, column 55 - line 679, column 30): " + [v1.constructor.name]);
          });
        });
      }
    });
  ...
  var handleViewExprAction = function(v) {
    ...
    if (v instanceof ExprInteraction_ViewExprAction) {
      return discard13(function() {
        ...
        ;
        throw new Error("Failed pattern match at Ui.Editor (line 582, column 3 - line 585, column 100): " + [v.value0.constructor.name]);
      }())(function() {
    ...
    if (v instanceof ViewPointOutput_ViewExprAction && v.value1 instanceof ViewPointInteraction) {
      return discard13(function() {
        ...
        ;
        throw new Error("Failed pattern match at Ui.Editor (line 592, column 3 - line 594, column 106): " + [v.value1.value0.constructor.name]);
      }())(function() {
        return lift5(raise(new Tuple(Nil.value, new ViewPointInteraction_ViewExprOutput(v.value0, v.value1.value0))));
      });
    }
    ;
    throw new Error("Failed pattern match at Ui.Editor (line 564, column 1 - line 564, column 58): " + [v.constructor.name]);
  };
  var handleSingleViewExprQuery = function(v) {
    ...
    if (v.value1 instanceof ViewPointQuery_ViewExprQuery) {
      return bind7(lift5(query1($$Proxy.value)(v.value1.value0)(v.value1.value1)))(function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at Ui.Editor (line 560, column 44 - line 562, column 23): " + [v1.constructor.name]);
      });
    }
    ;
    throw new Error("Failed pattern match at Ui.Editor (line 556, column 1 - line 556, column 68): " + [v.constructor.name]);
  };
    ...
    return discard13(traverse_14(function(qs) {
      ...
      if (v1.value0 instanceof Cons) {
        ...
        return bind7(lift5(query22($$Proxy.value)(v1.value0.value0)(qs$prime)))(function(v2) {
          ...
          ;
          throw new Error("Failed pattern match at Ui.Editor (line 551, column 50 - line 553, column 29): " + [v2.constructor.name]);
        });
      }
      ;
      throw new Error("Failed pattern match at Ui.Editor (line 547, column 5 - line 553, column 29): " + [v1.value0.constructor.name]);
    })(qss))(function() {
      return pure17(v.value1);
    });
  };
  var $lazy_viewExpr_component = /* @__PURE__ */ $runtime_lazy10("viewExpr_component", "Ui.Editor", function() {
    var render = function(state3) {
      return div2([classes2(["Expr"])])(fold4([[div2([classes(["ExprLabel"])])([function() {
        ...
        ;
        throw new Error("Failed pattern match at Ui.Editor (line 512, column 21 - line 514, column 42): " + [state3.expr.l.constructor.name]);
      }()])], function() {
        ...
        var renderKid = function(i2) {
          return function(e) {
            return slot3($$Proxy.value)(i2)($lazy_viewExpr_component(523))({
              expr: e
    ...
    var $$eval = mkEval({
      ...
      receive: function($555) {
        return pure18(Receive_ViewExprAction.create($555));
      },
      handleQuery: function(query32) {
        return bind16(get1)(function(state3) {
          return bind16(runExceptT(handleViewExprQuery(query32)))(function(v1) {
            if (v1 instanceof Left) {
              return discard24(put1(state3))(function() {
                return discard24(function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at Ui.Editor (line 485, column 13 - line 487, column 69): " + [v1.value0.constructor.name]);
                }())(function() {
                  return pure24(none3);
                });
              });
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 482, column 52 - line 489, column 35): " + [v1.constructor.name]);
          });
        });
      },
      handleAction: function(action2) {
          ...
          return bind16(runExceptT(handleViewExprAction(action2)))(function(v1) {
            if (v1 instanceof Left) {
              return discard24(function() {
                ...
                ;
                throw new Error("Failed pattern match at Ui.Editor (line 494, column 13 - line 496, column 69): " + [v1.value0.constructor.name]);
              }())(function() {
                return put1(state3);
              });
            }
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 492, column 54 - line 498, column 30): " + [v1.constructor.name]);
          });
        });
      }
    });
  ...
  var viewExpr_component = /* @__PURE__ */ $lazy_viewExpr_component(474);
  var handleEngineQuery = function(v) {
    if (v instanceof ExprInteraction_EngineQuery) {
      if (v.value1 instanceof Click_ViewExprAction) {
        return discard13(lift5(traceEngineM("Engine")(text6("got Click from Expr at " + show32("TODO: (Array.fromFoldable is)")))))(function() {
          return discard13(function() {
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 223, column 5 - line 228, column 20): " + [v1.constructor.name]);
          }())(function() {
      ...
      if (v.value1 instanceof StartDrag_ViewExprAction) {
        return discard13(function() {
            ...
            return discard13(lift5(traceEngineM("Editor . Drag")(text6("got StartDrag from Expr at " + show14(p2)))))(function() {
              return bind7(gets2(function(v2) {
                ...
                return discard13(modify_5(function(v2) {
                  var $446 = {};
                  for (var $447 in v2) {
                    if ({}.hasOwnProperty.call(v2, $447)) {
                      $446[$447] = v2[$447];
                    }
                    ;
                  }
                  ;
                  $446.drag_origin_handle = new Just(h$prime);
                  return $446;
                }))(function() {
          ...
          ;
          throw new Error("Failed pattern match at Ui.Editor (line 231, column 5 - line 240, column 21): " + [v1.constructor.name]);
        }())(function() {
          return pure17(v.value2);
        });
      }
      ...
      if (v.value1 instanceof MidDrag_ViewExprAction) {
        return discard13(function() {
          ...
          ;
          throw new Error("Failed pattern match at Ui.Editor (line 243, column 5 - line 249, column 28): " + [v1.constructor.name]);
        }())(function() {
          return pure17(v.value2);
        });
      }
      ;
      throw new Error("Failed pattern match at Ui.Editor (line 220, column 61 - line 250, column 11): " + [v.value1.constructor.name]);
    }
    ;
    if (v instanceof ViewPointInteraction_EngineQuery) {
        ...
        return discard13(lift5(traceEngineM("Editor . Drag")(text6("got StartDrag from Point at " + show14(v.value0)))))(function() {
          return bind7(gets2(function(v1) {
            ...
            return discard13(modify_5(function(v1) {
              var $462 = {};
              for (var $463 in v1) {
                if ({}.hasOwnProperty.call(v1, $463)) {
                  $462[$463] = v1[$463];
                }
                ;
              }
              ;
              $462.drag_origin_handle = new Just(h$prime);
              return $462;
            }))(function() {
      ...
      ;
      throw new Error("Failed pattern match at Ui.Editor (line 251, column 63 - line 262, column 11): " + [v.value1.constructor.name]);
    }
    ;
    if (v instanceof EndDrag_EngineQuery) {
      return discard13(lift5(traceEngineM("Editor . Drag")(text6("got EndDrag"))))(function() {
        return discard13(modify_5(function(v1) {
          ...
          ;
          $470.drag_origin_handle = Nothing.value;
          return $470;
        }))(function() {
    ...
    ;
    throw new Error("Failed pattern match at Ui.Editor (line 219, column 1 - line 219, column 59): " + [v.constructor.name]);
  };
  var handleEngineAction = function(v) {
        ...
        return bind7(liftEffect7(bindFlipped9(document)(windowImpl)))(function(doc) {
          return discard13(lift5(subscribe$prime(function(_subId) {
            return eventListener2(keydown)(toEventTarget(doc))(function() {
              var $556 = map26(function($558) {
                return Keyboard_EngineAction.create(fromKeyboardEventToKeyInfo($558));
              });
              return function($557) {
                return $556(fromEvent($557));
              };
            }());
          })))(function() {
            return pure17(unit);
      ...
      return bind7(get3)(function(v1) {
        return discard13(function() {
          if (v.value0.cmd && v.value0.key === "c") {
            ...
            return discard13(lift5(traceEngineM("Editor . Keyboard")(text6("copy: " + show42(frag)))))(function() {
              return modify_5(function(v22) {
                var $484 = {};
                for (var $485 in v22) {
                  if ({}.hasOwnProperty.call(v22, $485)) {
                    $484[$485] = v22[$485];
                  }
                  ;
                }
                ;
                $484.clipboard = pure18(frag);
                return $484;
              });
            });
          }
          ...
          if (v.value0.cmd && v.value0.key === "x") {
            ...
            return discard13(lift5(traceEngineM("Editor . Keyboard")(text6("cut: " + show42(v2.value0)))))(function() {
              return discard13(modify_5(function(v32) {
                var $494 = {};
                for (var $495 in v32) {
                  if ({}.hasOwnProperty.call(v32, $495)) {
                    $494[$495] = v32[$495];
                  }
                  ;
                }
                ;
                $494.clipboard = pure18(v2.value0);
                return $494;
              }))(function() {
          ...
          var $500 = v.value0.cmd && v.value0.key === "v";
          if ($500) {
            if (v1.clipboard instanceof Just) {
              var v3 = function() {
                if (v1.handle instanceof Point_Handle) {
                  ...
                  ;
                  throw new Error("Failed pattern match at Ui.Editor (line 313, column 29 - line 315, column 159): " + [v1.clipboard.value0.constructor.name]);
                }
                ;
                if (v1.handle instanceof SpanH_Handle) {
                  var at_h = atSpan(v1.handle.value0)(v1.expr);
                  ...
                  ;
                  if (v1.clipboard.value0 instanceof Zipper_Fragment) {
                    return new Tuple(todo2("new handle"), unContext(at_h.outside)(unZipper(v1.clipboard.value0.value0)(at_h.at)));
                  }
                  ;
                  throw new Error("Failed pattern match at Ui.Editor (line 318, column 35 - line 320, column 98): " + [v1.clipboard.value0.constructor.name]);
                }
                ;
                if (v1.handle instanceof ZipperH_Handle) {
                  var at_h = atZipper(v1.handle.value0)(v1.expr);
                  ...
                  ;
                  throw new Error("Failed pattern match at Ui.Editor (line 323, column 37 - line 325, column 102): " + [v1.clipboard.value0.constructor.name]);
                }
                ;
                throw new Error("Failed pattern match at Ui.Editor (line 312, column 28 - line 327, column 37): " + [v1.handle.constructor.name]);
              }();
              return discard13(lift5(traceEngineM("Editor . Keyboard")(text6("paste: " + show42(v1.clipboard.value0)))))(function() {
    ...
    ;
    throw new Error("Failed pattern match at Ui.Editor (line 268, column 1 - line 268, column 52): " + [v.constructor.name]);
  };
  var handleAction = function(v) {
    ...
    if (v instanceof EngineOutput_Action) {
      ...
      if (v.value0 instanceof SetExpr_EngineOutput) {
        return modify_5(function(v1) {
          var $530 = {};
          for (var $531 in v1) {
            if ({}.hasOwnProperty.call(v1, $531)) {
              $530[$531] = v1[$531];
            }
            ;
          }
          ;
          $530.expr = v.value0.value0;
          return $530;
        });
      }
      ;
      throw new Error("Failed pattern match at Ui.Editor (line 133, column 41 - line 136, column 59): " + [v.value0.constructor.name]);
    }
    ;
    if (v instanceof ViewExprOutput_Action) {
      ...
      ;
      throw new Error("Failed pattern match at Ui.Editor (line 137, column 53 - line 143, column 99): " + [v.value0.value1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Ui.Editor (line 125, column 1 - line 125, column 34): " + [v.constructor.name]);
  };
  var engine_component = /* @__PURE__ */ function() {
    ...
    var $$eval = mkEval({
      ...
      receive: function($559) {
        return pure18(Receive_EngineAction.create($559));
      },
      handleQuery: function(query32) {
        return bind16(get1)(function(state3) {
          return bind16(runExceptT(handleEngineQuery(query32)))(function(v1) {
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 193, column 50 - line 198, column 35): " + [v1.constructor.name]);
          });
        });
      },
      handleAction: function(action2) {
        return bind16(get1)(function(state3) {
          return bind16(runExceptT(handleEngineAction(action2)))(function(v1) {
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 201, column 52 - line 205, column 30): " + [v1.constructor.name]);
          });
        });
      }
    });
      ...
      handleAction: function(action2) {
        return bind16(get1)(function(state3) {
          return bind16(runExceptT(handleAction(action2)))(function(v1) {
            ...
            ;
            throw new Error("Failed pattern match at Ui.Editor (line 99, column 46 - line 103, column 30): " + [v1.constructor.name]);
          });
        });
      }
    });
